...
static void ImGui_ImplWin32_UpdateMousePos()
{
    ...
    const mvec mouse_pos_prev = io.MousePos;
    io.MousePos = mvec(-FLT_MAX, -FLT_MAX);
    ...
    if (::GetCursorPos(&pos) && ::ScreenToClient(mouse_window, &pos))
        io.MousePos = mvec((float)pos.x, (float)pos.y);
}
...
void    ImGui_ImplWin32_NewFrame()
{
    ...
    io.DisplaySize = mvec((float)(rect.right - rect.left), (float)(rect.bottom - rect.top));
